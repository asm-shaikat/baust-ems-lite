...
<div class="text-center mt-24">
      <div class="text-sm  text-blue-500"> 
         <h2 class="dark:text-white">Update Student info</h2>
</div>
...
<div class="flex justify-center my-2 mx-4 md:mx-0">
   <form class="w-full max-w-xl bg-slate-800 rounded-lg shadow-md p-6" action="{{ url('/recruiter/send-update-Students-info-details/'.$studentId->id) }}" method="POST" enctype="multipart/form">
      @csrf
      <div class="flex flex-wrap -mx-3 mb-6">
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2" for='Full_name'>Full name</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2" for='Department'>Department</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='batch'>Batch</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='batch'>Department ID (If have)</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='level'>Level</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='term'>Term</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Father_name'>Fathers Name</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Father_phone'>Father's Phone Number</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Mother_name'>Mother's Name</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Mother_phone'>Mother's Phone Number</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Birth_date'>Birth date</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Birth_Certificate_ID'>Birth Certificate ID</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Religion'>Religion</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Blood_Group'>Blood Group</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Student_mobile'>Student's Phone Number</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Parmanent_address'>Permanent Address</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Present_address'>Present address</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-white" for='Active'>Active</label>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            <button type="submit" class="appearance-none block w-full bg-blue-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-2 px-3 leading-tight hover:bg-blue-500 focus:outline-none focus:bg-white focus:border-gray-500">Submit</button>
         </div>
