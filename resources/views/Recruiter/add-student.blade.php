   ...
   <form class="w-full max-w-xl bg-white rounded-lg shadow-md p-6" action="{{ url('/recruiter/send_add_student_data') }}" method="post" enctype="multipart/form">
      ...
      <div class="flex flex-wrap -mx-3 mb-6">
         <div class="w-full md:w-full px-3 mb-6">
            ...
            <input type='text' name="name" placeholder="Student Full Name" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" required>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            ...
            <input name="batch" placeholder="Batch" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='number' min=1  required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='batch'>Department ID (If have)</label>
            <input name="d_id" placeholder="200101059" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='number' min=150101001>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
         ...
         <div class="w-full md:w-full px-3 mb-6">
            ...
            <input name="year" placeholder="Year's last 2 digit" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='number' min='15' required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='Father_name'>Fathers Name</label>
            <input name="f_name" placeholder="Father's Full Name" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='text'  required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
            ...
            <input name="f_phone" placeholder="0172345678" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='text' required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='Mother_name'>Mother's Name</label>
            <input name="m_name" placeholder="Mother's Full Name" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='text'  required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
            ...
            <input name="m_phone" placeholder="0172345678" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='tel' required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='Birth_date'>Birth date</label>
            <input name="b_date" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='date'  required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
            ...
            <input name="b_id" placeholder="Birth Certificate Number" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-2 leading-tight focus:outline-none" type='number'  required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='Religion'>Religion</label>
            <input name="religion" placeholder="Religion" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='text'  required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
         ...
         <div class="w-full md:w-full px-3 mb-6">
            ...
            <input name="s_phone" placeholder="0172345678" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='tel' required>
         ...
         <div class="w-full md:w-full px-3 mb-6">
            ...
            <input name="permanent_address" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='text'  required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='Present_address'>Present address</label>
            <input name="present_address" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" type='text'  required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='Email'>Email address</label>
            <input type='email' name="email" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-2 px-3 leading-tight focus:outline-none" required>
