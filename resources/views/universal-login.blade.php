...
<div class="h-screen flex justify-center items-center w-full -mt-16">
    <!-- form secction -->
      <div class="w-5/6 pl-28 ml-96">
    ...
    <!-- end of form secction -->
      ...
      <div class="w-1/6">
        ...
        <div id="alert2" class="flex p-4 mb-4 bg-red-100 rounded-lg dark:bg-red-200" role="alert">
          ...
          <div class="w-52 ml-3 text-sm font-medium text-red-700 dark:text-red-800">
